...
urlpatterns = [
    ...
    path("lecturers/", lecturer_list_view, name="lecturer_list"),
    path("lecturer/add/", staff_add_view, name="add_lecturer"),
    path("lecturer/<int:pk>/approve/", approve_lecturer, name="approve_lecturer"),
    ...
    path("student/<int:pk>/approve/", approve_student, name="approve_student"),
