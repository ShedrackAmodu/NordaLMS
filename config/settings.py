...
CSRF_TRUSTED_ORIGINS = ['https://LearningManagementSystem.pythonanywhere.com', 'https://learningmanagementsystem.pythonanywhere.com'] if not DEBUG else []
...
# Custom apps
PROJECT_APPS = [
    "scripts",  # For custom management commands
...
# E-mail Configuration (Console Only)
EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"
EMAIL_FROM_ADDRESS = "your-email@example.com"  # Replace with a placeholder email
...
STUDENT_ID_PREFIX = config("STUDENT_ID_PREFIX", "NDS")
...
LEVEL_CHOICES = (
    (BACHELOR_DEGREE, _("Beginner")),
    (MASTER_DEGREE, _("Professional")),
)
